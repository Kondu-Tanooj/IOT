...
String updateWebpage(uint8_t LEDstatus) {
  ...
  ptr += "const newUrl = '/automatic';";
  ptr += "window.history.pushState({}, '', newUrl);";
  ...
  ptr += "}";
  ptr += "});\n";
  ptr += "switch1.addEventListener('change',()=>{";
  ptr += "if(switch1.checked){";
  ptr += "const newUrl = '/sw1-on';";
  ptr += "window.history.pushState({}, '', newUrl);";
  ptr += "} else{";
  ptr += "const newUrl = '/sw1-off';";
  ptr += "window.history.pushState({}, '', newUrl);";
  ptr += "}";
  ptr += "});\n";
  ptr += "switch2.addEventListener('change',()=>{";
  ptr += "if(switch2.checked){";
  ptr += "const newUrl = '/sw2-on';";
  ptr += "window.history.pushState({}, '', newUrl);";
  ptr += "} else{";
  ptr += "const newUrl = '/sw2-off';";
  ptr += "window.history.pushState({}, '', newUrl);";
  ptr += "}";
  ptr += "});\n";
  ptr += "switch3.addEventListener('change',()=>{";
  ptr += "if(switch3.checked){";
  ptr += "const newUrl = '/sw3-on';";
  ptr += "window.history.pushState({}, '', newUrl);";
  ptr += "} else{";
  ptr += "const newUrl = '/sw3-off';";
  ptr += "window.history.pushState({}, '', newUrl);";
  ptr += "}";
  ptr += "});\n";
  ptr += "</script>\n";
